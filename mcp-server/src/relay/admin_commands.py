...
# Compatibilidad de imports históricos; el dominio Equipo vive en admin_users.
from .admin_users import api_me, api_users_list, api_user_upsert, api_user_delete  # noqa: F401,E402
